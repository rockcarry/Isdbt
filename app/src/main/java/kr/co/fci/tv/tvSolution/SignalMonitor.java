...
public class SignalMonitor {
    ...
    public int getSignal()
    {
        ...
        if (buildOption.FCI_SOLUTION_MODE == buildOption.JAPAN
            ...
            if (CommonStaticData.handoverMode > CommonStaticData.HANDOVER_MODE_OFF || CommonStaticData.isSwitched == true) {
                handover_counter = 0;
            }
        }
        ...
        if (segType == 0) { // 1seg
            ...
            if (MainActivity.getInstance() != null) {
                if (MainActivity.getInstance().strISDBMode.equalsIgnoreCase("ISDBT Oneseg")) {
                    ...
                    if (MainActivity.getInstance().is_inserted_card==2) {  // no B-CAS interface
                        if (CommonStaticData.receivemode==CommonStaticData.RECEIVE_MODE_AUTO && CommonStaticData.scanCHnum > 0 && CommonStaticData.scanningNow==false && CommonStaticData.handoverMode==CommonStaticData.HANDOVER_MODE_OFF) {
                        ...
                        if (CommonStaticData.receivemode==CommonStaticData.RECEIVE_MODE_AUTO && CommonStaticData.scanCHnum > 0 && CommonStaticData.scanningNow==false && (MainActivity.getInstance().is_inserted_card==1) && CommonStaticData.handoverMode==CommonStaticData.HANDOVER_MODE_OFF) {
                            //if (currentSignalVal[0]<250 && currentCN>17){
                            //if (currentSignalVal[2] < 250 && currentPER < 100) {
                            if (fullSegBER < 250 && fullSegPER < 100) {
                                moveFullTh++;
